...
class RandomChance(Layer):
    def __init__(self, transform: Layer, probability, name=None, **kwargs):
...
@tf.keras.utils.register_keras_serializable(package="Chambers")
class ImageNetNormalization(Layer):
